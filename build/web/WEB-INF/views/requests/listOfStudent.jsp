...
<html>
    ...
    <body>
        ...
        <div class="row justify-content-between" style="margin: 10px auto;">
            <div class="tab" class="pull-left badge bg-white">
                <button class="tablinks active" style="background-color: green; border: none; color: white; border-radius:5px; height: 50px" >Accepted</button>
                <button class="tablinks" style="background-color: crimson; border: none; color: white; border-radius:5px; height: 50px ">Declined</button>
            </div>
        </div>
                ...
                <form action="<c:url value="/requests/searchByStudent.do"/>">    
                    ...
                    <div class="row justify-content-center mt-5">
                        ...
                        <table class="table text-center table-striped table-bordered">
                            ...
                            <tbody>
                                <c:forEach var="requests" items="${list1}" varStatus="loop">
                                    <tr>
                                        <td>${requests.ID}</td>
