<%-- 
    ...
    Created on : Oct 30, 2023, 12:23:47 AM
    Author     : Dell
--%>
        ...
        <c:choose>
            <c:when test="${roleID.equals('2 ')}">
                <div class="container mt-5 ">
                    <div style="">
                        <!--<form action="<c:url value="/timetables/readExcel.do"/>">-->
                        <form method="post" enctype="multipart/form-data">
                            <!--                                                        <label style="margin: 10px auto; width: 1300px" class="custom-file-label btn-rounded" for="fileName">Choose file</label>
                            ...
                            <button type="submit" class="btn btn-info btn-block mb-2 ml-2" value="Upload">
                                <i class="bi bi-file-earmark-spreadsheet"></i> Generate from Excel
                            </button>
